        ...
        <div className="aboutBox">
          <div className="about_leftBox">
            <h1 style={{ fontSize: "1.5rem" }}>
              Hi, 👋 I am <h3 className="about_box_h3">Nitin Sharma_</h3>
            </h1>
        ...
        <div className="aboutSection">
          ...
          <div className="right">
            ...
            <p>
              ...
              <span className="DescriptionSpanTag"> Chakra-Ui</span>,
              <span className="DescriptionSpanTag"> TailwindCSS</span>,
              <span className="DescriptionSpanTag"> Nodejs</span>,
              <span className="DescriptionSpanTag"> ExpressJS</span> and
              <span className="DescriptionSpanTag"> MongoDB</span> i make
